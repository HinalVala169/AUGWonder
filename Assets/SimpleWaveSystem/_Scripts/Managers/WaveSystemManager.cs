...
namespace RehtseStudio.SimpleWaveSystem.Managers
{
    ...
    public class WaveSystemManager : MonoBehaviour
    {
        ...
        public int ReturnObjectTypeId(int waveId, int i)
        {
            return _wavesReference[waveId].ReturnObjectType(i);
        }

        public WaveSystemSO ReturnWaveSystemSO(int waveId)
        {
            return _wavesReference[waveId];
        }
